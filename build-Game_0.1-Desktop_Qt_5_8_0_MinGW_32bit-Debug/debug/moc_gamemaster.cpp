...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GameMaster_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GameMaster_t qt_meta_stringdata_GameMaster = {
    {
QT_MOC_LITERAL(0, 0, 10), // "GameMaster"
QT_MOC_LITERAL(1, 11, 6), // "update"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "GameMaster\0update\0"
};
...
const QMetaObject GameMaster::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameMaster.data,
      qt_meta_data_GameMaster,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GameMaster::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameMaster.stringdata0))
